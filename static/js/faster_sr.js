window.addEventListener('load', async () => {
  function preloadImages() {
    const blackswan_imageSrc = (i) => `static/demo/blackswan_sr/${String(i).padStart(5, '0')}.jpg`;
...
// 调用函数并传入 JSON 文件的 URL
  const data = await loadAndParseJSON('static/demo/kpts_sr.json');
// window.data = data;
  ...
  // Usage
  displayFramesWithSlider("static/demo/blackswan_sr/", 49); // Example with 100 frames
